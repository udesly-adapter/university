...
const Cards = () => {
    ...
    return (
        <section className="white-section transparent">
            <div className="cards">
                <div className="card card__dark">
                    <h3>No time to work on your next project?</h3>
                    <p>Our team of Webflow experts is ready to help you speed up the daily workflow and create professional web projects.</p>
