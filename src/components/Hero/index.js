        ...
        <div className="hero">
            <div className="hero-content-wrapper">
                <div className="hero-text-wrap">
                    <h1 className="hero-heading">Easy docs, tips & tricks, tutorials...</h1>
                    ...
                    </div><div className="button-container"><a href="https://www.udesly.com/why-udesly" target="_blank" rel="noopener noreferrer" className="arrow-link w-button">Why you should use Udesly </a></div></div><div className="hero-image-wrapper"><img src={heroImage} alt="udesly-hero" className="hero-image" /></div></div>
        </div>
    );
