...
document.addEventListener('paste', e => {
 ...
 try {
    const element = b64EncodeUnicode(ULZSS.encode(encodeURIComponent(data)));

    console.log(`<copy-element name="Sample Element">${element}</copy-element>`);
 } catch(e) {
    const element = b64EncodeUnicode(data);

    console.log(`<copy-element name="Sample Element" b64>${element}</copy-element>`);
 }
